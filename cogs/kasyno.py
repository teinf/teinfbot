...
class Kasyno(commands.Cog):
    ...
    async def ruletka(self, ctx, *args):
        ...
        try:
            ...
            em.add_field(name="Info", value="**Czarny/Czerwony/Zielony** - jeżeli bot wyrzuci Twój **kolor**, wygrywasz\n**0-36** - jeżeli bot wyrzuci Twój **numer**, wygrywasz\n**Niskie/Wysokie** - **niskie** = 1-18, **wysokie** = 19-36\n**Nieparzyste/Parzyste** - **nieparzyste** = 1, 3, 5, ..., 35, **parzyste** = 2, 4, 6, ..., 36", inline=False)
            em.add_field(name="Wygrane", value = "**Czarny/Czerwony** - 2x\n**0-36** lub **Zielony** - 35x\n**wysoki/niski** - 2x\n**parzysty/nieparzysty** - 2x",inline=False)
            em.add_field(name="Numery", value=":green_heart: Zielony: **0**\n:black_heart: Czarne: **2, 4, 6, 8, 10, 11, 13, 15, 17, 20, 22, 24, 26, 28, 29, 31, 33, 35**\n:heart: Czerwone: **1, 3, 5, 7, 9, 12, 14, 16, 18, 19, 21, 23, 25, 27, 30, 32, 34, 36**",inline=True)
